...
public class Step_Defination {
	...
	public void user_Buying_the_Desired_Property() throws Throwable {
	    ...
	    WebElement buybutton = driver.findElement(By.xpath("(//div[@class='nb__17yFj'])[1]"));
	    buybutton.click();
	...
	public void user_Select_the_City() throws Throwable {
		...
		WebElement city = driver.findElement(By.xpath("//div[@class='css-1hwfws3 nb-select__value-container nb-select__value-container--has-value']"));
		city.click();
	...
	public void user_Enter_Locality_in_Search_Box() throws Throwable {
		...
		WebElement searchbox = driver.findElement(By.xpath("//input[@id='listPageSearchLocality']"));
	...
	public void user_Select_the_Apartment_Types() throws Throwable {
		...
		WebElement apartmentType = driver.findElement(By.xpath("(//div[@class='css-v2nw5i-control nb-select__control'])[2]"));
		apartmentType.click();
	...
	public void user_Click_Search_button_and_Navigates_To_Property_Listing_Page() throws Throwable {
		...
		WebElement searchbutton = driver.findElement(By.xpath("//button[@class='prop-search-button btn btn-default btn-lg btn-block']"));
	    searchbutton.click();
	    
	    WebElement info = driver.findElement(By.xpath("//div[@class='leave-intent-close-icon']"));
	    info.click();
	...
	public void user_ScrollDown_the_Property_Page_into_Desired_Property() throws Throwable {
		...
		WebElement property = driver.findElement(By.xpath("(//span[@class='overflow-hidden overflow-ellipsis whitespace-nowrap max-w-80pe po:max-w-full'])[4]"));
	...
	public void user_ScrollDown_the_Selected_Property_Page_into_Description_Section() throws Throwable {
		...
		WebElement description = driver.findElement(By.xpath("(//div[@class='nb__zmA_z nb__9LNOV'])[1]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public void user_Confirm_Whether_The_Description_Present_Or_Not() throws Throwable {
		...
		if (text.equalsIgnoreCase("Description")) {
			...
			WebElement descriptionContent = driver.findElement(By.xpath("//div[@id='description']"));
